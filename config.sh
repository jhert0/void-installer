...
PACKAGES="xorg cinnamon emacs-gtk3 git zsh tmux firefox alacritty mpd ncmpcpp gnupg2 libreoffice curl vpsm neovim vim connman connman-gtk pulseaudio pinentry-gtk zip unzip"
KEYMAP="us"
